...
export const environment = {
  ...
  firebaseApiUrl: 'https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=',
  firebase: {
  ...
  tripStartUnixTimeStamp: 1661659200, // Set to 12:00 am on starting day of trip
  mode: 'multi-location', // 'simple' is the other config name
  // Map Settings
  weatherSettings: [
    {
      city: 'Liscannor',
  ...
  zoomCarouselMap: 5,
  accommodationsImage: '../assets/icons/country-house.png',
  ...
  buffer: 16.64e+8, // ~ 20 Days in milliseconds
  translate: true,
  // Asset Paths
  ...
  imagePaths: [
    ...
    {path: '/assets/pictures/welcome-2.jpeg'},
    {path: '/assets/pictures/welcome-3.jpeg'},
    {path: '/assets/pictures/welcome-4.png'}
  ],
  // Itinerary Config
  ...
  customUrl: 'https://www.google.com/maps/place/18%C2%B032\'00.9%22N+68%C2%B022\'10.5%22W',
